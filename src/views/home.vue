  ...
  <div class="home-container">
    ...
    <div class="home-hero">
      <div class="home-container01">
        <div class="home-card">
          <h1 class="home-text HeadingOne">OpenGL Rendering System.</h1>
          <h1 class="home-text01 HeadingOne">
            Use most optimized rendering and physics system with SmugEngine
          </h1>
          <span class="home-text02 Lead">
            <span>
              Find the story of Creative Tim&apos;s most complex design
              <span v-html="rawepbu"></span>
            </span>
    ...
    <img alt="image" src="/curved6-1500h.jpg" class="home-image" />
    <section class="home-features">
      <feature-card
        ...
        image_src="/cube1.svg"
      ></feature-card>
      <feature-card image_src="/person1.svg"></feature-card>
      <feature-card
    ...
    <section class="home-container04">
    ...
    <section class="home-testimonials">
          ...
          <div class="home-container17">
            <div class="home-container18">
              <div class="home-container19">
                <img alt="image" src="/logo-asana.svg" class="home-image04" />
              </div>
              <div class="home-container20">
                <img alt="image" src="/logo-slack.svg" class="home-image05" />
              </div>
            ...
            <div class="home-container22">
              <div class="home-container23">
                <img alt="image" src="/logo-shopify.svg" class="home-image07" />
              </div>
              ...
              <div class="home-container25">
                <img alt="image" src="/logo-invision.svg" class="home-image09" />
              </div>
            </div>
            <div class="home-container26">
              <div class="home-container27">
                <img alt="image" src="/logo-attlasian.svg" class="home-image10" />
              </div>
              <div class="home-container28">
                <img alt="image" src="/logo-weave.svg" class="home-image11" />
              </div>
            </div>
          </div>
        </div>
      ...
      <img alt="image" src="/waves-white.svg" class="home-image12" />
    ...
    <section class="home-contaier">
      ...
      <div class="home-container36">
        ...
        <div class="home-container38">
          <div class="home-container39"></div>
