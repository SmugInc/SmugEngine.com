  ...
  <div data-role="Header" class="header-header">
    <nav class="header-nav">
      <div class="header-container">
        <nuxt-link to="/" class="header-navlink Large">SmugEngine</nuxt-link>
        <div class="header-menu">
          <nuxt-link to="/" class="header-navlink1 Large">Home</nuxt-link>
          <nuxt-link to="/profile" class="header-navlink2 Large">
            Profile
          </nuxt-link>
          <nuxt-link to="/coming-soon" class="header-navlink3 Large">
            Coming Soon
          </nuxt-link>
        </div>
    ...
    <div data-role="MobileMenu" class="header-mobile-menu">
      <div class="header-top">
        <nuxt-link to="/" class="header-navlink4 Large">
      ...
      <div class="header-mid">
        <div class="header-menu1">
          <nuxt-link to="/" class="header-navlink5 Large">Home</nuxt-link>
          <nuxt-link to="/profile" class="header-navlink6 Large">
            Profile
          </nuxt-link>
          <nuxt-link to="/coming-soon" class="header-navlink7 Large">
            Coming Soon
          </nuxt-link>
        </div>
      </div>
