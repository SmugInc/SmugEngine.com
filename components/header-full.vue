  ...
  <div class="header-full-header">
    <nav class="header-full-nav">
      <div class="header-full-container">
        <nuxt-link to="/" class="header-full-navlink Large">
          Soft UI Design System
        </nuxt-link>
        <div class="header-full-menu">
          <nuxt-link to="/" class="header-full-navlink1 Large">Home</nuxt-link>
          <nuxt-link to="/profile" class="header-full-navlink2 Large">
            Profile
          </nuxt-link>
          <nuxt-link to="/coming-soon" class="header-full-navlink3 Large">
            Coming Soon
          </nuxt-link>
        </div>
